...
stock_market    = kensington.outlets.create(
  ...
  location: 'Mathews food court [UPPER]', 
...
sushi_matthews  = kensington.outlets.create(
  name: 'Sushi in Mathews', 
  description: 'Sushi in Mathews', 
  location: 'Matthews food court [UPPER]', 
  website: '')

sushi_matthews.foods.create(
...
tropical_green  = kensington.outlets.create(
  name: 'Tropical Green', 
  description: '', 
  location: 'Near Mathews upstairs [UPPER]', 
...
blue_stone  = kensington.outlets.create(
  ...
  description: '', 
  location: 'Near Morven Brown [UPPER]', 
  website: '')
